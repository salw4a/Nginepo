...
@section('content')
    <div class="max-w-7xl mx-auto px-6 py-8">
        <div class="mb-8">
            <form method="GET" action="{{ route('admin.properti.index') }}" class="max-w-2xl mx-auto">
                <div class="relative">
                    <input
                        type="text"
                        name="lokasi"
        ...
        <div class="mt-8">
            <a href="{{ route('admin.properti.index') }}" class="inline-flex items-center px-4 py-2 text-brown-900 bg-white border border-brown-300 rounded-lg hover:bg-brown-50 transition-colors">
