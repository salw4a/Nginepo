...
<div class="flex flex-col items-center min-h-screen py-10 bg-white">
    ...
    <form class="w-full max-w-md">
        ...
        <!-- Total Properti -->
        <div class="mb-6">
            <label for="total properti" class="block text-sm font-medium text-gray-700 mb-1">Total Properti</label>
            <input type="text" id="properti" name="properti"
                class="w-full px-4 py-2 rounded-md bg-[#c49a7d] text-black focus:outline-none" />
        </div>
