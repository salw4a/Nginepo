    ...
    <div class="max-w-3xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            ...
            <div class="space-y-8">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">kata_sandi</label>
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-800 p-3 bg-gray-50 rounded-lg">{{ $user->jumlah_properti }}</p>
                </div>
            </div>
